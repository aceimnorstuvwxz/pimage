...
void main() {
  group('Image', () {
    test('float16', () async {
      final i1 =
          Image(width: 2, height: 2, format: Format.float16, numChannels: 1);
      expect(i1.width, equals(2));
      expect(i1.height, equals(2));
      expect(i1.numChannels, equals(1));
      expect(i1.format, Format.float16);
      i1
      ...
      final i2 =
          Image(width: 2, height: 2, format: Format.float16, numChannels: 2);
      ...
      final i3 = Image(width: 2, height: 2, format: Format.float16);
      ...
      final i4 =
          Image(width: 2, height: 2, format: Format.float16, numChannels: 4);
