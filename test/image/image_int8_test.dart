...
void main() {
  group('Image', () {
    test('int8', () async {
      final i1 =
          Image(width: 2, height: 2, format: Format.int8, numChannels: 1);
      expect(i1.width, equals(2));
      expect(i1.height, equals(2));
      expect(i1.numChannels, equals(1));
      expect(i1.format, Format.int8);
      i1
      ...
      final i2 =
          Image(width: 2, height: 2, format: Format.int8, numChannels: 2);
      ...
      final i3 = Image(width: 2, height: 2, format: Format.int8);
      ...
      final i4 =
          Image(width: 2, height: 2, format: Format.int8, numChannels: 4);
