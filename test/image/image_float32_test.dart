...
void main() {
  group('Image', () {
    test('float32', () async {
      final i1 =
          Image(width: 2, height: 2, format: Format.float32, numChannels: 1);
      expect(i1.width, equals(2));
      expect(i1.height, equals(2));
      expect(i1.numChannels, equals(1));
      expect(i1.format, Format.float32);
      i1
      ...
      final i2 =
          Image(width: 2, height: 2, format: Format.float32, numChannels: 2);
      ...
      final i3 = Image(width: 2, height: 2, format: Format.float32);
      ...
      final i4 =
          Image(width: 2, height: 2, format: Format.float32, numChannels: 4);
